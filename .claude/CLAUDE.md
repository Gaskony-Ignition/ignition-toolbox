...
# Create release
git tag v3.0.8
git push origin v3.0.8  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.8`
5. Push tag: `git push origin v3.0.8`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.8) - All Development Phases Complete
