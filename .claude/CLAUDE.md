...
# Create release
git tag v3.0.5
git push origin v3.0.5  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.5`
5. Push tag: `git push origin v3.0.5`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.5) - All Development Phases Complete
