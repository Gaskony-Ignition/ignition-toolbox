...
# Create release
git tag v3.1.2
git push origin v3.1.2  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.1.2`
5. Push tag: `git push origin v3.1.2`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.1.2) - All Development Phases Complete
