...
# Create release
git tag v3.0.6
git push origin v3.0.6  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.6`
5. Push tag: `git push origin v3.0.6`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.6) - All Development Phases Complete
