...
# Create release
git tag v3.1.3
git push origin v3.1.3  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.1.3`
5. Push tag: `git push origin v3.1.3`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.1.3) - All Development Phases Complete
