...
# Create release
git tag v3.1.6
git push origin v3.1.6  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.1.6`
5. Push tag: `git push origin v3.1.6`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.1.6) - All Development Phases Complete
