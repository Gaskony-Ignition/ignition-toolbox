...
# Create release
git tag v3.0.4
git push origin v3.0.4  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.4`
5. Push tag: `git push origin v3.0.4`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.4) - All Development Phases Complete
