...
# Create release
git tag v3.0.9
git push origin v3.0.9  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.9`
5. Push tag: `git push origin v3.0.9`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.9) - All Development Phases Complete
