...
# Create release
git tag v3.0.11
git push origin v3.0.11  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.11`
5. Push tag: `git push origin v3.0.11`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.11) - All Development Phases Complete
