...
# Create release
git tag v3.0.7
git push origin v3.0.7  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.7`
5. Push tag: `git push origin v3.0.7`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.7) - All Development Phases Complete
