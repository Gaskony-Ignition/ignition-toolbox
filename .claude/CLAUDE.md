...
# Create release
git tag v3.1.0
git push origin v3.1.0  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.1.0`
5. Push tag: `git push origin v3.1.0`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.1.0) - All Development Phases Complete
