...
# Create release
git tag v3.0.12
git push origin v3.0.12  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.12`
5. Push tag: `git push origin v3.0.12`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.12) - All Development Phases Complete
