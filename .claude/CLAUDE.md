...
# Create release
git tag v3.0.10
git push origin v3.0.10  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.0.10`
5. Push tag: `git push origin v3.0.10`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.0.10) - All Development Phases Complete
