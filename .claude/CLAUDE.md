...
# Create release
git tag v3.2.0
git push origin v3.2.0  # Triggers GitHub Actions build
```
...
4. Create version tag: `git tag v3.2.0`
5. Push tag: `git push origin v3.2.0`
...
**Maintainer**: Nigel G
**Status**: Production Ready (v3.2.0) - All Development Phases Complete
