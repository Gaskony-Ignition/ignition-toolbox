...
async def check_for_updates() -> dict | None:
    ...
    Returns:
        ...
        Update dict format:
        {
            ...
            "release_url": "https://github.com/Gaskony-Ignition/ignition-toolbox/releases/tag/v4.1.0",
            "release_notes": "Markdown changelog...",
            "download_url": "https://github.com/Gaskony-Ignition/ignition-toolbox/archive/refs/tags/v4.1.0.tar.gz",
